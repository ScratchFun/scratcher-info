...
var http = {
	...
	post: function(e, t, n) {
		...
		return s.open("POST", e), s.onreadystatechange = function() {
			s.readyState > 3 && 200 == s.status && n(s.responseText)
		}, s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), s.send(o), s
	}
};
...
Scratch.timeago=function(e,s,a){s=s||days,a=a||new Date;var t=Date.parse(a)-Date.parse(e),n={centuries:31536e8,decades:31536e7,years:31556952e3,months:2629746e3,weeks:6048e5,days:864e5,hours:36e5,minutes:6e4,seconds:1e3,milliseconds:1};return Math.round(t/n[s])};
var info = {
	...
	joined_data: { // Special %method's ago from date joined
		...
		weeks_ago: Scratch.timeago(data.history.joined, 'years'),
